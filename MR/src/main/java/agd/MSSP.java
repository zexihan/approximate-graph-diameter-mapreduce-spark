...
public class MSSP extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        conf.set("source1", args[3]);
        conf.set("source2", args[4]);
...
//		}
        ...
        while (numUpdated > 0) {
            ...
            job.setJarByClass(MSSP.class);
            job.setMapperClass(MSSPMapper.class);
            job.setReducerClass(MSSPReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new MSSP(), args);
